                  ...
                  {matches.map((match) => (
                    <div key={match.id} className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm hover:border-blue-300 transition-colors">
                      <div className="bg-slate-50 px-4 py-2 border-b border-slate-200 flex justify-between items-center text-xs font-semibold text-slate-500 uppercase tracking-wide">
                        ...
                        <span className={`px-2 py-1 rounded-full ${match.estado === "finalized" ? 'bg-green-100 text-green-700' : 'bg-amber-100 text-amber-700'}`}>
                          {match.estado}
                        </span>
                      </div>
                      <div className="p-5 flex justify-between items-center relative">
                         ...
                         <div className="flex flex-col items-center flex-1">
                             ...
                             {match.estado === "finalized" && match.ganador_id === match.equipo_local_id && <Trophy className="h-4 w-4 text-yellow-500 mt-1"/>}
                         </div>
                         {/* VS */}
                         ...
                         <div className="flex flex-col items-center flex-1">
                             ...
                             {match.estado === "finalized" && match.ganador_id === match.equipo_visitante_id && <Trophy className="h-4 w-4 text-yellow-500 mt-1"/>}
                         </div>
                      </div>
                    </div>
                  ))}
